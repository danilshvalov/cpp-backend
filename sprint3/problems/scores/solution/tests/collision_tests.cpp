...
TEST_CASE(
    ...
    SECTION("X axis") {
        Gatherer gatherer {
            .start_pos = Point {item.position.x + offset, 0.0},
            .end_pos =
                Point {
    ...
    SECTION("Y axis") {
        Gatherer gatherer {
            .start_pos = Point {0.0, item.position.y + offset},
            .end_pos =
                Point {
                    item.position.x,
